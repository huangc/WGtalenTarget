...
* blat_at_pTALENdel/: The deletion site from reference sequence plus its surrounding GAP_BORDER size, as reported in SeqDel_pTALENs-on-*.OUT (generated by x3-WGtalen), are retrieved for blat alignment against sample contig for evaluation of the pTALEN target site.
